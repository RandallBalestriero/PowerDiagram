...
screen -dmS YY bash -c "sleep 1;export CUDA_VISIBLE_DEVICES='4';python run_cnn_vs_mlp.py CIFAR";
screen -dmS XX bash -c "sleep 1;export CUDA_VISIBLE_DEVICES='5';python run_cnn_vs_mlp.py SVHN";
