...
screen -dmS D bash -c "sleep 1;export CUDA_VISIBLE_DEVICES='2';python run_bias_constraint.py 0 1 constrained CIFAR";
screen -dmS E bash -c "sleep 1;export CUDA_VISIBLE_DEVICES='5';python run_bias_constraint.py 0 1 unconstrained CIFAR";
screen -dmS F bash -c "sleep 1;export CUDA_VISIBLE_DEVICES='4';python run_bias_constraint.py 0 1 zero CIFAR";
